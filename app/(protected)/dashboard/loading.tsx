  ...
  return (
    <div className="p-6 flex flex-col gap-6 w-full animate-pulse">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white rounded-2xl border border-[#e2e8f0] shadow-[0_2px_8px_rgba(0,0,0,0.05)] p-5 flex justify-between items-start">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-5 min-w-0">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-[0_2px_8px_rgba(0,0,0,0.05)] p-5 flex flex-col gap-4 min-w-0">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-[0_2px_8px_rgba(0,0,0,0.05)] p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 flex-1">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex justify-between items-center py-2.5 border-b border-[#e2e8f0]">
