...
const SkeletonCard = () => (
  <div className="p-4 space-y-3 border-b border-cream">
...
export default function Loading() {
  return (
    <div className="min-h-full p-4 sm:p-6 bg-cream">
      ...
      {/* Table card skeleton */}
      <div className="bg-white rounded-2xl border border-line shadow-[0_2px_18px_rgba(26,46,41,0.05)] overflow-hidden">
        {/* Toolbar */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-4 border-b border-line">
            ...
            <thead>
              <tr className="bg-cream border-b border-line">
                {["Customer", "Designation / Company", "Message", "Rating", "Status", "Last Updated", "Actions"].map((h) => (
                  <th
                    key={h}
                    className="px-5 py-3 text-left text-xs font-semibold text-mutedfg uppercase tracking-wider whitespace-nowrap"
                  >
                    {h}
                  </th>
                ))}
        ...
        {/* Footer */}
        <div className="px-5 py-3 border-t border-line bg-cream/60">
