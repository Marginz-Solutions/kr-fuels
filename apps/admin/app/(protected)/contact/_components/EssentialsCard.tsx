    ...
    <div style={{ ...card(), overflow: "hidden", padding: 0 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Building2 size={16} color={C.p} />
        </div>
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: C.t }}>Company information</div>
          <div style={{ fontSize: 11, color: C.p, marginTop: 1 }}>Core details, emails & phone numbers</div>
        </div>
      </div>
      ...
      <div style={{ padding: "20px 20px 0" }}>
        ...
        <FormField label="HQ city (shown in website price ticker)">
          <input style={inp()} value={essentials.hqCity ?? ""} placeholder="Tiruchirappalli"
            onChange={(e) => setEssentials({ ...essentials, hqCity: e.target.value })} />
        </FormField>
