...
const TITLE = "Auto LPG Stations In Tamil Nadu | K.R Trans Fuels";
const DESCRIPTION =
  "Auto LPG Stations Across Tamil Nadu With K.R Trans Fuels. Locate Nearby LPG Fuel Stations, Check Auto LPG Prices, And Enjoy Cleaner, Cost-Effective Mobility.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: BRAND.name,
    images: [{ url: "/assets/og.jpg", width: 1920, height: 700, alt: TITLE }],
  },
  twitter: {
