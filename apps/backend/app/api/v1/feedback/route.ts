...
import { FeedbackSchema } from "@kr/shared/validators/feedback.schema"
...
export async function GET(req: NextRequest) {
    try {
        ...
        // Count uses the SAME orderBy as the list so docs missing `createdAt`
        // (which orderBy filters out) are excluded from the total too — otherwise
        // the count and the listed rows diverge (e.g. "1–10 of 14" but 13 rows).
